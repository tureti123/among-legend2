...
socket.on('t',async ()=>{
    ...
    async function activation(){
        ...
        socket.on('imposteur', () => {
            ...
            imageContainer.innerHTML = `<img src="among-us-imposteur.jpg" style="width: 300px; height: auto;" alt="Image">`;
        })
        ...
        socket.on('doubleface', (mele) => {
            ...
            perdre en fonction des ordres que tu vas recevoir'
            //imageContainer.innerHTML = `<img src="" alt="Image">`;
        })
...
async function creationtab(h){
    ...
    validation.setAttribute("class",`btn`)
    ...
    rempli.setAttribute("class",`btn`)
    rempli.innerText='validation kp'
...
return compte
    ...
    console.log(document.getElementById("volumecontrol").value)
    document.getElementsByName("audible")[1].volume = document.getElementById("volumecontrol").value
    document.getElementsByName("audible")[0].volume = document.getElementById("volumecontrol").value
    document.getElementsByName("audible")[2].volume = document.getElementById("volumecontrol").value
    })
function audiotest(){
